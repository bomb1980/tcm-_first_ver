...
class Request2_3Controller extends Controller
{
    public function getRequest2_3(Request $request)
    {
        ...
        'ooap_tbl_reqform.plan_startdate','ooap_tbl_reqform.plan_enddate','ooap_mas_coursegroup.name as coursegroup_name','ooap_mas_coursesubgroup.name as ooap_mas_coursesubgroup_name',
