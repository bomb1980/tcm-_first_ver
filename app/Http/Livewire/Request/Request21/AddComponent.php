...
class AddComponent extends Component
{
    ...
    public function render()
    {
        ...
        $this->job_wage_amt = $this->day_qty * $this->people_qty * $this->job_wage_rate;
        // $this->other_amt = $this->other_rate ?? 0;
        $this->total_amt = number_format($this->job_wage_amt, 2) ?? 0;
        ...
        return view('livewire.request.request21.add-component');
    }
}
