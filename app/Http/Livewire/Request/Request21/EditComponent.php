...
namespace App\Http\Livewire\Request\Request21;
...
class EditComponent extends Component
{
  ...
  public function mount()
  {
    ...
    $this->cmname = $data->cmname;
    $this->cmleader_name = $data->cmleader_name;
    $this->cmleader_position = $data->cmleader_position;
  ...
  public function submit_toconfirm()
  {
    ...
    // dd($this);
    $array_left = array_column($this->file_array_old, 'files_id') ?? []; // ไฟล์ที่เหลือจากลบแล้ว
  ...
  public function render()
  {
    ...
    return view('livewire.request.request21.edit-component');
  }
}
