...
class AddComponent extends Component
{
  ...
  public function submit_prototype($status)
  {
    ...
    $this->validate([
      ...
      'people_qty' => 'required',
      'trainer_qty' => 'required',
      'day_qty' => 'required',
    ], [
      'fiscalyear_code.required' => 'กรุณาเลือก ปีงบประมาณ',
      'dept_id.required' => 'กรุณาเลือก หน่วยงาน',
      'coursegroup_id.required' => 'กรุณาเลือก กลุ่มหลักสูตร',
      'people_qty.required' => 'กรุณากรอก จำนวนคน',
      'trainer_qty.required' => 'กรุณากรอก จำนวนวิทยากร',
      'day_qty.required' => 'กรุณากรอก จำนวนวัน',
    ]);
    $data = OoapTblReqform::create([
  ...
  public function render()
  {
    ...
    if ($this->course_lunch_rate > $this->acttype2->couse_lunch_maxrate) {
      $this->course_lunch_rate = $this->acttype2->couse_lunch_maxrate;
    }
    if ($this->course_trainer_rate > $this->acttype2->couse_trainer_maxrate) {
      $this->course_trainer_rate = $this->acttype2->couse_trainer_maxrate;
    }
    if ($this->course_material_rate > $this->acttype2->couse_material_maxrate) {
      $this->course_material_rate = $this->acttype2->couse_material_maxrate;
    }
    ...
    return view('livewire.request.request22.add-component');
  }
}
