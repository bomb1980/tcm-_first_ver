...
namespace App\Http\Livewire\Request\Request32;
...
class EditComponent extends Component
{
    ...
    public function mount($pullreqform)
    {
        ...
        $this->stdate = datetoview($pullreqform->plan_startdate);
        $this->endate = datetoview($pullreqform->plan_enddate);
    ...
    public function submit_prototype($status)
    {
        ...
        OoapTblReqform::where('reqform_id', '=', $this->reqform_id)->update([
            ...
            // 'cmleader_id' => 1, //suppose to be nullable and wrong name
            'cmleader_desp' => $this->cmleader_desp, //this column's not exist
    ...
    public function render()
    {
        ...
        return view('livewire.request.request32.edit-component');
    }
}
