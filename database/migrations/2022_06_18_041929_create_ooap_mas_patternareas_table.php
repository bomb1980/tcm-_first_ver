...
class CreateOoapMasPatternareasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ooap_mas_patternareas', function (Blueprint $table) {
            $table->integer('patternarea_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('ooap_mas_patternareas');
    }
}
