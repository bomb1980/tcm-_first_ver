...
class CreateOoapMasCoursegroupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ooap_mas_coursegroup', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ooap_mas_coursegroup');
    }
}
