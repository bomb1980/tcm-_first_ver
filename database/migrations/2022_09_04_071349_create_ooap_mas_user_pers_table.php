...
class CreateOoapMasUserPersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ooap_mas_user_per', function (Blueprint $table) {
            $table->integer('user_per_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('ooap_mas_user_per');
    }
}
