...
class CreateOoapMasLecturersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ooap_mas_lecturers', function (Blueprint $table) {
            $table->integer('lecturer_id')->autoIncrement();
            $table->string('lecturer_fname')->nullable();
            $table->string('lecturer_lname')->nullable();
            $table->string('lecturer_phone')->nullable();
            $table->string('lecturer_address')->nullable();

            $table->integer('province_id')->nullable();
            $table->integer('lecturer_types_id')->nullable();
    ...
    {
        Schema::dropIfExists('ooap_mas_lecturers');
    }
}
