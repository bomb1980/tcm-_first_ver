...
class CreateOoapMasAssessmentTopicsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ooap_mas_assessment_topics', function (Blueprint $table) {
            $table->integer('assessment_topics_id')->autoIncrement();
            $table->string('assessment_topics_name')->nullable();
    ...
    {
        Schema::dropIfExists('ooap_mas_assessment_topics');
    }
}
