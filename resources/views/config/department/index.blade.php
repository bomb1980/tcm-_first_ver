    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('config.department.create'),' เพิ่มหน่วยงาน',['class'=>'btn btn-primary
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.config.department.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'dept_code', name: 'dept_code', className: "text-left", orderable: true },
                { data: 'dept_name_th', name: 'dept_name_th', className: "text-left", orderable: true },
                { data: 'dept_short_name', name: 'dept_short_name', className: "text-left", orderable: true },
