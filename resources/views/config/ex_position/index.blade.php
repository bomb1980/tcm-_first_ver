    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('config.ex_position.create'),' เพิ่มตำแหน่งบริหารงานใหม่',['class'=>'btn btn-primary
                btn-md
    ...
    <div class="page-content container-fluid">
        <div class="panel">
            <div class="panel-body container-fluid">
                ...
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('config.ex-positions-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.config.ex_position.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'executive_positons_name_th', name: 'executive_positons_name_th', className: "text-left", orderable: true },
                { data: 'executive_positions_description', name: 'executive_positions_description', className: "text-left", orderable: true },
