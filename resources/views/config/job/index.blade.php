    ...
    <div class="page-header">
        ...
        {{-- <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('config.job.create'),' เพิ่มเวลาดึงข้อมูล',['class'=>'btn btn-primary
                btn-md
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            columns: [
                ...
                { data: 'job_name', name: 'job_name', className: "text-center", orderable: true },
                { data: 'job_run', name: 'job_run', className: "text-center", orderable: true },
