    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('config.position.create'),' เพิ่มตำแหน่งงานใหม่',['class'=>'btn btn-primary
                btn-md
    ...
    <div class="page-content container-fluid">
        <div class="panel">
            <div class="panel-body container-fluid">
                ...
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('config.position-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.config.position.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'posit_name_th', name: 'posit_name_th', className: "text-left", orderable: true },
                { data: 'posit_description', name: 'posit_description', className: "text-left", orderable: true },
