    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('config.positionle.create'),' เพิ่มระดับตำแหน่งงาน',['class'=>'btn btn-primary
    ...
    <div class="page-content container-fluid">
        <div class="panel">
            <div class="panel-body container-fluid">
                ...
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('config.positionle-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.config.positionle.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'positlevel_name_th', name: 'positlevel_name_th', className: "text-left", orderable: true },
                { data: 'positlevel_description', name: 'positlevel_description', className: "text-left", orderable: true },
