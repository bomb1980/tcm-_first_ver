<div>
    <div class="row">
        <div class="col-md-2 form-group">
            ...
            <button type="button" class="btn btn-primary form-control form-group" {{ $panel == 4 ? 'disabled' : '' }}
            ...
            <div class="{{ $status == 1 ? '' : 'd-none' }}">
                ...
                <button type="button" class="form-control form-group btn btn-success"
                    wire:click="submit_toconfirm(2)">บันทึกส่งตรวจสอบ</button>
                <button type="button" class="form-control form-group btn btn-danger"
                    wire:click="submit_prototype(9)">ยกเลิก</button>
            </div>
            <div class="{{ $status != 1 ? '' : 'd-none' }}">
            ...
            <div class="panel-body container-fluid">
                ...
                <div class="{{ $panel == 1 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            ...
                            {!! Form::select('dept_id', $dept_list, $dept_id, ['onchange' => 'setValue("dept_id",event.target.value)', 'class' => 'form-control select2', 'placeholder' => '--เลือกประเภทหน่วยงาน--']) !!}
                            @error('dept_id')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror --}}
                        </div>
                ...
                <div class="{{ $panel == 2 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('acttye_id', $acttye_list, $acttye_id, ['onchange' => 'setValue("acttye_id",event.target.value)', 'class' => 'form-control select2', 'disabled']) !!}
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-4">
                            <label for="">กลุ่มหลักสูตร</label>
                            {!! Form::select('coursegroup_id', $coursegroup_list, null, ['wire:change' => 'changeCoursegroup($event.target.value)', 'class' => 'form-control', 'placeholder' => '--เลือกกลุ่มหลักสูตร--']) !!}
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('coursesubgroup_id', $coursesubgroup_list, null, ['wire:change' => 'changeCoursesubgroup($event.target.value)', 'class' => 'form-control', 'placeholder' => '--เลือกกลุ่มสาขาอาชีพ--']) !!}
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('course_id', $course_list, null, ['wire:change' => 'changeCourse($event.target.value)', 'class' => 'form-control', 'placeholder' => '--เลือกหลักสูตร--']) !!}
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-6">
                            <label for="">ชื่อกิจกรรม</label>
                            <textarea rows="4" class="form-control" wire:model="actname" placeholder="ชื่อกิจกรรม"></textarea>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-6">
                            <label for="">รายละเอียดกิจกรรม</label>
                            <textarea rows="6" class="form-control" wire:model="actdetail" placeholder="รายละเอียดกิจกรรม"></textarea>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-6">
                            <label for="">หมายเหตุ</label>
                            <textarea rows="6" class="form-control" wire:model="actremark" placeholder="หมายเหตุ"></textarea>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="พิกัดแผนที่ละติจูด" wire:model="building_lat">
                        </div>
                        <div class="col-md-3 form-group">
                ...
                <div class="{{ $panel == 3 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-3 form-group">
                            ...
                            {!! Form::select('province_id', $province_list, $province_id, ['onchange' => 'setValue("province_id",event.target.value)', 'class' => 'form-control select2', 'placeholder' => '--เลือกจังหวัด--']) !!}
                            @error('province_id')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                    ...
                    <div class="row form-group"> --}}
                        <div class="col-md-3 form-group">
                            ...
                            {!! Form::select('amphur_id', $amphur_list, $amphur_id, ['onchange' => 'setValue("amphur_id",event.target.value)', 'class' => 'form-control select2', 'placeholder' => '--เลือกอำเภอ--']) !!}
                            @error('amphur_id')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                        <div class="col-md-3 form-group">
                            ...
                            {!! Form::select('tambon_id', $tambon_list, $tambon_id, ['onchange' => 'setValue("tambon_id",event.target.value)', 'class' => 'form-control select2', 'placeholder' => '--เลือกตำบล--']) !!}
                            @error('tambon_id')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror
                        </div>
                ...
                <div class="{{ $panel == 4 ? '' : 'd-none' }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('people_qty', null, ['wire:model' => 'people_qty', 'id' => 'people_qty', 'class' => 'form-control']) !!}
                        </div>
                        <label class="col-md-1 form-control-label pl-4">จำนวนวิทยากร</label>
                        <div class="col-md-2">
                            {!! Form::number('trainer_qty', null, ['wire:model' => 'trainer_qty', 'id' => 'trainer_qty', 'class' => 'form-control']) !!}
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('course_lunch_rate', null, ['wire:model' => 'course_lunch_rate', 'id' => 'course_lunch_rate', 'class' => 'form-control']) !!}
                        </div>
                        <label class="col-md-1 form-control-label pl-4">ค่าอาหาร</label>
                        <div class="col-md-2">
                            {!! Form::number('course_lunch_amt', null, ['wire:model' => 'course_lunch_amt', 'id' => 'course_lunch_amt', 'class' => 'form-control', 'disabled']) !!}
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('course_trainer_rate', null, ['wire:model' => 'course_trainer_rate', 'id' => 'course_trainer_rate', 'class' => 'form-control']) !!}
                        </div>
                        <label class="col-md-2 form-control-label pl-4">ค่าตอบแทนวิทยากร</label>
                        <div class="col-md-2">
                            {!! Form::number('course_trainer_amt', null, ['wire:model' => 'course_trainer_amt', 'id' => 'course_trainer_amt', 'class' => 'form-control', 'disabled']) !!}
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('course_material_rate', null, ['wire:model' => 'course_material_rate', 'id' => 'course_material_rate', 'class' => 'form-control']) !!}
                        </div>
                        <label class="col-md-1 form-control-label pl-4">ค่าวัสดุ</label>
                        <div class="col-md-2">
                            {!! Form::number('course_material_amt', null, ['wire:model' => 'course_material_amt', 'id' => 'course_material_amt', 'class' => 'form-control', 'disabled']) !!}
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('other_amt', null, ['wire:model' => 'other_amt', 'id' => 'other_amt', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row pt-4 pb-1 bg-info">
                        ...
                        <div class="col-md-2">
                            {!! Form::number('total_amt', null, ['wire:model' => 'total_amt', 'id' => 'total_amt', 'class' => 'form-control', 'disabled']) !!}
                        </div>
                    </div>
