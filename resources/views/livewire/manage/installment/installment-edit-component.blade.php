        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker"
                            data-date-language="th-th" onchange="setDatePicker('startdate', event.target.value)" wire:model="startdate"
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker"
                            data-date-language="th-th" onchange="setDatePicker('enddate', event.target.value)" wire:model="enddate"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input type="number" wire:model="left_per" class="form-control text-right" placeholder="เหลือสัดส่วน {{ number_format($left_per ,2) }} %" disabled>
