            ...
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        <input type="text" class="form-control" data-date-language="th-th" wire:model="transfer_date" data-plugin="datepicker" onchange="setValue('transfer_date', event.target.value)" placeholder="วว/ดด/ปปปป">
