    ...
    <div class="col-lg-12">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    {!! Form::select('province_id', $province_select, null,
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    {!! Form::select('amphur_id', $amphur_select, null,
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    {!! Form::select('tambon_id', $tambon_select, null,
            ...
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        {!! Form::text('cmleader_birthdate', null, ['wire:model' => 'cmleader_birthdate','id' => 'cmleader_birthdate', 'class' => 'form-control', 'data-provide' => 'datepicker','data-date-language' => 'th-th','readonly' => 'true']) !!}
