        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    ['wire:change' => 'coursegroupchange(event.target.value)', 'class' => 'form-control select2', 'id' => 'coursegroup_id','placeholder' => 'กรุณาเลือกกลุ่มหลักสูตร']) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    ['wire:change' => 'coursesubgroupchange(event.target.value)', 'class' => 'form-control select2', 'id' => 'coursesubgroup_id','placeholder' => 'กรุณาเลือกกลุ่มสาขาอาชีพ']) !!}
