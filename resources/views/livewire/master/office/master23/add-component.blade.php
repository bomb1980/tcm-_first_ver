        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    ...
                    ['wire:model'=>'schedulecode','id'=>'schedulecode', 'class' => 'form-control','maxlength' => 10,'placeholder'=>'ไม่เกิน 10 ตัวอักษร']) !!}
                    @error('schedulecode')
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    ['wire:model'=>'schedulename','id'=>'schedulename', 'class' => 'form-control','maxlength' => 500,'placeholder'=>'ไม่เกิน 500 ตัวอักษร']) !!}
                    @error('schedulename')
                    <label class="text-danger">{{ $message }}</label>
                    @enderror
                </div>
