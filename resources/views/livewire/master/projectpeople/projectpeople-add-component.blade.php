            ...
            <div class="panel-body text-center">
                ...
                <div class="tab-content">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2 hidden-sm-down">
                                <div style=" position:absolute">
                                    @error('pathfilepeoname')
                                    <label class="text-danger">{{ $message }}</label>
                                    @enderror
                                    <input type="file" wire:model="pathfilepeoname" id="getimage" class="btn-secondary" accept="image/*">
                    ...
                    <div class="hidden-sm-up form-group">
                        ...
                        <label class="text-danger">{{ $message }}</label>
                        @enderror
                        <input type="file" wire:model="pathfilepeoname" id="getimage" class="btn-secondary col-md-12">
