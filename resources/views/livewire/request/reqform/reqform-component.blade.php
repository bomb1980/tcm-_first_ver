        ...
        <div class="col-md-2">
            <div class="card card-inverse bg-secondary">
                <div class="card-block text-center">
                    ...
                    <p class="h5 font-weight-bold text-white"><span id="col2"></span> รายการ</p>
                    <p class="h5 font-weight-bold text-white">จำนวนเงิน <span id="col1"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card card-inverse bg-warning">
                <div class="card-block text-center">
                    ...
                    <p class="h5 font-weight-bold text-white"><span id="col4"></span> รายการ</p>
                    <p class="h5 font-weight-bold text-white">จำนวนเงิน <span id="col3"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card card-inverse bg-success">
                <div class="card-block text-center">
                    ...
                    <p class="h5 font-weight-bold text-white"><span id="col6"></span> รายการ</p>
                    <p class="h5 font-weight-bold text-white">จำนวนเงิน <span id="col5"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card card-inverse bg-danger">
                <div class="card-block text-center">
                    ...
                    <p class="h5 font-weight-bold text-white"><span id="col8"></span> รายการ</p>
                    <p class="h5 font-weight-bold text-white">จำนวนเงิน <span id="col7"></span></p>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="card card-inverse bg-primary">
                <div class="card-block text-center">
                    ...
                    <p class="h5 font-weight-bold text-white"><span id="col12"></span> รายการ</p>
                    <p class="h5 font-weight-bold text-white">จำนวนเงิน <span id="col11"></span></p>
                </div>
            </div>
        </div>
    </div>
