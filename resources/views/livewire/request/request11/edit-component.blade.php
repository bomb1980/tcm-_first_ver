    ...
    <div class="col-lg-12">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    {!! Form::text('fiscalyear_code', $fiscalyear_code,
                    ['wire:model'=>'fiscalyear_code','id'=>'fiscalyear_code', 'class' => 'form-control','maxlength' =>
                    4,'placeholder'=>'ไม่เกิน 4 ตัวอักษร']) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        {!! Form::text('req_startdate', $req_startdate, ['wire:model' => 'req_startdate','id' =>
                        'req_startdate', 'class' => 'form-control', 'data-provide' => 'datepicker','data-date-language'
                        => 'th-th','readonly' => 'true']) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        {!! Form::text('req_enddate', $req_startdate, ['wire:model' => 'req_enddate','id' =>
                        'req_enddate', 'class' => 'form-control', 'data-provide' => 'datepicker','data-date-language' =>
                        'th-th','readonly' => 'true']) !!}
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="icon wb-calendar" aria-hidden="true"></i>
            ...
            <div class="text-center">
                ...
                <button class="btn btn-default btn-outline"><a
                        href="{{ route('request.request1.request1_1.index') }}">ยกเลิก</a></button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
