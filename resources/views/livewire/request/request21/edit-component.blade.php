<div class="row">
    <div class="col-md-2 form-group">
        ...
        <div class="{{ $status == 1 ? '' : 'd-none' }}">
            ...
            <button type="button" class="w-full form-group btn btn-danger" onclick="check_function()">ยกเลิก</button>
        </div>
        <div class="{{ $status != 1 ? '' : 'd-none' }}">
            ...
            <div class="{{ $panel == 2 ? '' : 'd-none' }}">
                ...
                <div class="row form-group {{ $patternarea_id != 2 ? 'd-none' : '' }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control text-right"
                            placeholder="ปริมาณพื้นที่ (ตารางเมตร/ตารางกิโลเมตร)" disabled wire:model="area_total">
                        {{-- @error('area_total')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror --}}
                    </div>
                ...
                <div class="row form-group {{ $patternarea_id != 3 ? 'd-none' : '' }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control text-right" placeholder="ตารางเมตร/ตารางกิโลเมตร"
                            disabled wire:model="area_total">
                        {{-- @error('area_total')
                            <label class="text-danger">{{ $message }}</label>
                            @enderror --}}
                    </div>
