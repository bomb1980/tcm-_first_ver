        ...
        <div class="form-group col-md-10 panel">
            <div class="panel-body container-fluid">
                ...
                <div class="{{ $panel == 1 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label for="">ปีงบประมาณ <span class="text-danger">*</span></label>
                ...
                <div class="{{ $panel == 2 ? '' : 'd-none' }}">
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            <label for="">กลุ่มหลักสูตร <span class="text-danger">*</span></label>
                            @error('coursegroup_id')
                                <label class="text-danger">{{ $message }}</label>
                            @enderror
                            {!! Form::select('coursegroup_id', $coursegroup_list, null, [
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('coursesubgroup_id', $coursesubgroup_list, null, [
                                'wire:change' => 'changeCoursesubgroup($event.target.value)',
                                'class' => 'form-control',
                                'placeholder' => '--เลือกกลุ่มสาขาอาชีพ--',
                            ]) !!}
                            {{-- @else
                                {!! Form::select('coursesubgroup_id', ['--ไม่มีกลุ่มสาขาอาชีพ--'], null, ['class' => 'form-control', 'disabled']) !!}
                            @endif --}}
                        </div>
