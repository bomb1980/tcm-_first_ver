...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">สร้างแบบฟอร์มประเมินผู้นำชุมชนประเมินกิจกรรมจ้างงานเร่งด่วน</h1>
        <ol class="breadcrumb">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.center.master22.create'),' เพิ่มระดับ',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.center.master22.index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.center.master22.list") }}',
                type: 'GET',
