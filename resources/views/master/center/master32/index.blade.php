...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">สร้างแบบฟอร์มผู้เข้าอบรมประเมินภาพรวมกิจกรรมทักษะฝีมือแรงงาน</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/') }}" class="keychainify-checked">หน้าแรก</a></li>
            <li class="breadcrumb-item"><a href="#"
                    class="keychainify-checked">ข้อมูล Master กยผ.</a></li>
            <li class="breadcrumb-item active">ระดับความพึงพอใจ</li>
        </ol>
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.center.master32.create'),' เพิ่มระดับ',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.center.master32.index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.center.master32.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'formtopic', name: 'formtopic', className: "text-left", orderable: true },
                { data: 'level', name: 'level', className: "text-center", orderable: true },
