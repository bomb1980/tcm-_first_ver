    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.center.master51.create'),' เพิ่มหัวข้อความพึงพอใจ',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.center.master51.index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.center.master51.list") }}',
                type: 'GET',
