    ...
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">หัวข้อประเมิน กิจกรรมพัฒนาทักษะฝีมือแรงงาน</li>
            </ol>
        </div>
            ...
            <div class="panel">
                <header class="panel-heading">
                    <h3 class="panel-title"><i class="icon wb-plus-circle" aria-hidden="true"></i>
                        แก้ไขหัวข้อประเมิน กิจกรรมพัฒนาทักษะฝีมือแรงงาน
                    </h3>
                </header>
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            @livewire('master.estimate.estimate-edit-component', ['data' => $data])
                        </div>
                    </div>
                </div>
            </div>
