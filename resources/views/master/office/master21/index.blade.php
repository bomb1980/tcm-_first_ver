    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.office.master21.create'),' เพิ่มกลุ่มหลักสูตร',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.office.master21.index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.office.master21.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'coursename', name: 'coursename', className: "text-left", orderable: true },
