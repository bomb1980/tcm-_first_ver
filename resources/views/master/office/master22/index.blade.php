...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">กลุ่มสาขาอาชีพ</li>
        </ol>
        <div class="page-header-actions">
            <div class="btn-group btn-group-sm">
                {{ link_to(route('master.office.master22.create'),' เพิ่มกลุ่มสาขาอาชีพ',['class'=>'btn
                btn-primary btn-md
        ...
        <div class="panel">
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        @livewire('master.office.master22.index-component')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            dom: 'rtp<"bottom"i>',
            ajax: {
                url: '{{ route("api.master.office.master22.list") }}',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'carreername', name: 'carreername', className: "text-left", orderable: true },
