...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">รายการแบบคำขอทำโครงการ</h1>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">รายการแบบคำขอทำโครงการ</li>
        </ol>
    ...
    function call_datatable(search) {
        var table = $('#Datatables').DataTable({
            ...
            columns: [
                ...
                { data: 'day_qty', name: 'day_qty', className: "text-right", orderable: true },
                { data: 'people_qty', name: 'people_qty', className: "text-right", orderable: true },
                { data: 'total_amt_format', name: 'total_amt_format', className: "text-right", orderable: true },
