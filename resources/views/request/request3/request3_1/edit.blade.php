...
@section('content')
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">ขั้นตอนพิจารณาแบบคำขอทำโครงการ (กิจกรรมจ้างงานเร่งด่วน)</h1>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">ขั้นตอนพิจารณาแบบคำขอทำโครงการ (กิจกรรมจ้างงานเร่งด่วน)</li>
            </ol>
        ...
        <div class="page-content container-fluid">
            ...
            <div class="row row-lg">
                <div class="col-md-12">
                    @livewire('request.request31.edit-component', ['reqform_id' => $reqform_id])
                </div>
            </div>
            {{-- </div>
        </div> --}}
