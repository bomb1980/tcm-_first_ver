...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">บันทึกข้อมูลการเสนองบประมาณ</h1>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">บันทึกข้อมูลการเสนองบประมาณ</li>
        </ol>
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-md-12">
                        ...
                        @livewire('request.sum-list.index-component')
                    </div>
                </div>
            </div>
        </div>
